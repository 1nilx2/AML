...
Then <img src="https://latex.codecogs.com/svg.image?P\Bigg(|\sum_{i=1}^\tau&space;X_i&space;|&space;>&space;\sqrt{2&space;\tau&space;(2log\tau&space;&plus;&space;log(1&space;\backslash&space;\delta)}\Bigg)&space;\leqq&space;\delta" title="https://latex.codecogs.com/svg.image?P\Bigg(|\sum_{i=1}^\tau X_i | > \sqrt{2 \tau (2log\tau + log(1 \backslash \delta)}\Bigg) \leqq \delta" />
